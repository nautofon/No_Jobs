The [orange]No Jobs: only remotes[normal] mod removes all city definitions (and thereby all jobs) except for cities that are fairly remote. As such, it puts an emphasis on rural highways.
