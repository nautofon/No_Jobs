The [orange]No Jobs: only edges[normal] mod removes all city definitions (and thereby all jobs) except for cities located along the edge of
the accessible world map. As such, it puts an emphasis on highways close to the edge of the map.
