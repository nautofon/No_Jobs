The [orange]No Jobs: only biggest[normal] mod removes all city definitions (and thereby all jobs) except for a handful of the biggest cities. As such, it puts an emphasis on the use of freeways.
